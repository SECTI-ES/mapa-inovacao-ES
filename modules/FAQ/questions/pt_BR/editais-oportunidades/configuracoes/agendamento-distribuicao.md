# Quando acontece o agendamento da distribuição das inscrições?
...
Sempre que uma das ações listadas abaixo acontece, é feito um agendamento para a distribuição das inscrições entre os avaliadores de todas as comissões, que será executado no horário informado.
...
- Quando um **avaliador é adicionado, removido, habilitado ou desabilitado**
