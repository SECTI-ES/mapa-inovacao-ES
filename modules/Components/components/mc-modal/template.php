...
');
?>
<vue-final-modal v-model="modalOpen" :classes="['modal-container',classes]" content-class="modal-content" transition="modal" modalPosition="fixed" :modalClasses="['modal-fixed']" :esc-to-close="escToClose" :click-to-close="clickToClose" @closed="closed()">
