app.component("entity-field", {
    ...
    data() {
        ...
        if (
            description.registrationFieldConfiguration?.fieldType ===
            "custom-table"
        ) {
        ...
        if (this.is("custom-table")) {
            if (!this.entity[this.prop]) {
                ...
                if (typeof this.entity[this.prop] === "string") {
                    try {
                        this.entity[this.prop] = JSON.parse(
                            this.entity[this.prop],
                        );
                    } catch (e) {
                        this.entity[this.prop] = [];
        ...
        isReadonly() {
            ...
            if (this.entity.__objectType == "registration") {
                ...
                if (Array.isArray(allowedFields) && allowedFields.length > 0) {
                    if (
                        allowedFields.includes(this.prop) &&
        ...
        addRow() {
            if (this.is("custom-table")) {
                ...
                if (
                    !maxRows ||
                    maxRows <= 0 ||
                    this.entity[this.prop].length < maxRows
                ) {
                    this.entity[this.prop].push({});
                        ...
                        .catch(() => {
                            ...
                            if (this.entity.__validationErrors) {
                                if (previousFieldError !== undefined) {
                                    ...
                                    delete this.entity.__validationErrors[
                                        this.prop
                                    ];
                                }
                            }
